"""Box events (SPEC §6.5) and the HTTP batch format (§7.3)."""
...
from box_protocol.common import NfcUid, NonNegativeInt, ProtocolModel, ProviderName
from box_protocol.envelope import EnvelopeCore, RawEnvelope
