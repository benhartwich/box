"""Device HTTPS API (SPEC §7). Responses are built from ``box_protocol`` models."""
...
from box_protocol.errors import ErrorCode
from box_protocol.events import EventBatchRequest, EventBatchResponse
...
from box_server.api.device.deps import CurrentDevice
from box_server.api.device.errors import ApiError, rate_limited
from box_server.api.device.jwt import DeviceClaims, issue
from box_server.api.web.deps import DbSession, SettingsDep, client_ip
from box_server.auth import ratelimit
from box_server.auth.tokens import hash_token
from box_server.domain import devices, events, pairing, state
from box_server.domain.errors import NotFoundError
from box_server.models import Asset, Device
from box_server.storage.base import SHA256_RE
