...
Code must never log secrets in the first place (CLAUDE.md, SPEC §10). The redaction here is
defense in depth for accidental leaks through exception messages, request data or third-party
libraries.
"""
...
def configure_logging(level: str = "INFO", fmt: str = "json") -> None:
    ...
    # uvicorn's access log would include query strings (poll_token, SPEC §7.1); we log
    # requests ourselves without them (see app.AccessLogMiddleware).
